...
def get_dealers_from_cf(url, **kwargs):
    ...
    req = get_request(url)
    json_result = req
    print(f"look for me #1: {type(json_result)}")
    if json_result:
    ...
    #     for dealer in dealers:
    #         dealer_object = CarDealer(address=dealer['address'],
    #                                   city=dealer['city'],
    ...
    if json_result:
        ...
        if db:
            ...
            for review in reviews:
                ...
                review_object.sentiment = analyze_review_sentiments(review_doc['review'])
